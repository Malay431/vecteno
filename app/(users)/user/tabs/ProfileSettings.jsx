...
export default function ProfileSettings() {
  ...
  const uploadToCloudinary = async () => {
    ...
    data.append("cloud_name", "drhhwftek");
    data.append("folder", "vecteno_users");

    const res = await fetch(
      `https://api.cloudinary.com/v1_1/drhhwftek/image/upload`,
      {
        method: "POST",
        body: data,
      }
  ...
  <img
    ...
    alt="Profile Preview"
    className="w-32 h-32 rounded-full object-cover pt-2"
  />
) : (
